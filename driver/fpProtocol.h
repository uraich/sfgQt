...
#define FP_NO_OF_PAGES         16
#define FP_DEFAULT_DATA_PKT_LENGTH    128
...
public:
    ...
    int fpInit(string,uint8_t);
    int fpClose(void);
    void fpSetDebug(bool);
    bool fpDebugIsOn();
    void fpSetDangerous(bool);
    void fpEnableDangerous(bool);
    void printDangerousWarning(void);
    ...
    int fpCreateDataPacket(uint8_t *, uint16_t *,uint8_t *);
    int fpCreateEndPacket(uint8_t *, uint16_t *,uint8_t *);
    ...
    int fpCreatePacket(uint16_t, uint32_t, uint8_t, uint16_t, uint8_t *, uint8_t *);
    ...
    int fpGenImg(void);
    int fpUpImage(void);
    int fpDownImage(uint16_t *,uint8_t *);
    ...
    int fpRegModel(void);
    int fpCreateBitmap(uint8_t *, const char *);
    void fpPrintError(char);
    string fpGetErrorString(char);
    uint8_t fpGetErrorCode(uint8_t *);
    bool fpIsAcknowledgePacket(uint8_t *);
    int fpSendCharBuf(uint16_t *,uint8_t *);
    int fpSendImage(uint8_t *);
    int fpSendImageData(uint16_t *,uint8_t *);
    int fpSendData(uint8_t,uint16_t *,uint8_t *);
    int fpWriteNotepad(uint8_t, uint8_t *);
    int fpReadNotepad(uint8_t, uint8_t *);
    int fpMatch(uint16_t *);
    int fpSearch(uint8_t, uint16_t, uint16_t, uint16_t *, uint16_t *);
    int fpEmpty(void);
    int fpDeleteChar(uint16_t, uint16_t);
    int fpGetParameterSize(uint8_t, uint16_t *, uint16_t *);
};
#endif
